...
export default class JumpingLettersClass extends Component {
	...
	render() {
		// const text = `Be water, my friend!`;
		// const lettersArray = text.split('')
		return (
			<div class="box">
				<JumpingLetters/>
				<div class="inner">
					{/* {lettersArray.map((letter, id) => <div key={id} className="letter">{letter}</div>)} */}
